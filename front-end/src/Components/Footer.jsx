        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    ...
                    <p className="mb-2"><i class="bi bi-geo-alt-fill"></i>     123 Street, New York, USA</p>
                    <p className="mb-2"><i class="bi bi-telephone-fill"></i>    +012 345 67890</p>
                    <p className="mb-2"><i class="bi bi-envelope-fill"></i>    info@example.com</p>
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <div className="position-relative w-100">
                        ...
                        <button type="button"   className="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2 sign">SignUp</button>
                    </div>
                </div>
            </div>
        </div>
